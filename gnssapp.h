/*****************************************************************************
   ...
   SW PACKAGE:    STA8088 GPS library and application
------------------------------------------------------------------------------
   DESCRIPTION:   The main application to run and test STA8088 GPS library
------------------------------------------------------------------------------
...
extern tVoid          gnssapp_low_power_setup_update  ( gnss_app_lowpow_standby_type_t, gnss_low_power_cyclic_mode_t *, gnss_low_power_periodic_mode_t *) ;
extern gpOS_error_t   gnssapp_low_power_fix_request   ( void);
extern void           gnssapp_low_power_fix_abort     ( void);
